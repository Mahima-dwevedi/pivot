    ...
    <div class="row-fluid">
        <div class="span12 margin_top20">
			...
			<?= Html::a('Advanced Search', null,
				['href' => 'javascript:void(0);', 'class' => 'search-button btn btn-inverse']) ?>
                ...
                <ul>
					...
					if (Yii::$app->session->getFlash('create')) {
						...
						if (Yii::$app->session->getFlash('update')) {
							...
							if (Yii::$app->session->getFlash('deletecms')) {
							...
							[
								...
								'value' => function ($data) {
									return date("d M, Y H:i",
										strtotime($data->modifiedDate)); // $data['name'] for array data, e.g. using SqlDataProvider.
								},
							...
							[
								...
								'buttons' => [
									'info' => function ($url, $model) {
										return Html::a('<span class="glyphicon icon-list-alt my_font_icon"></span>',
											$url, [
