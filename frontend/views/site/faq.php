...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 content_wrap">
            <div class="tophd_txt">
                <h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sollicitudin, massa nec hendrerit
                    tempor, mi leo condimentum dui,</h3>
                Search Answer
            </div>
            <div class="input-group">
				<?php
                
                $data = \app\models\faq::find()->where(['status' => '1'])
                            ...
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse<?php echo $data->id; ?>">
